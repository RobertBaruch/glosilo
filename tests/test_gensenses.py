...
class TestGensenses(unittest.TestCase):
    ...
    def test_process_snc_list_single(self):
        ...
        snc_list = [
            {"snc": {"content": [{"dif": {"content": [{"text": "First sense"}]}}]}}
        ]
    ...
    def test_process_snc_list_multiple(self):
        ...
        snc_list = [
            {"snc": {"content": [{"dif": {"content": [{"text": "First sense"}]}}]}},
            {"snc": {"content": [{"dif": {"content": [{"text": "Second sense"}]}}]}},
        ]
        result = process_snc_list(snc_list, None, {})
        ...
        snc_list = [
            {
                "snc": {
                    "content": [
                        {"dif": {"content": [{"text": "First sense"}]}},
                        {
                            "snc": {
                                "content": [
                                    {"dif": {"content": [{"text": "First subsense"}]}}
                                ]
                            }
                        },
                        {
                            "snc": {
                                "content": [
                                    {"dif": {"content": [{"text": "Second subsense"}]}}
                                ]
                            }
                        },
                    ]
